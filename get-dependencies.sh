...
ZIP_LINK=$(wget -qO- https://api.github.com/repos/MegaMan64Recomp/MegaMan64Recompiled/releases \
      | sed 's/[()",{} ]/\n/g' | grep -o -m 1 "https.*MegaMan64Recompiled.*$zip_arch.zip")
...
bsdtar -xvf ./MegaMan64Recompiled.tar.gz -C ./AppDir/bin
